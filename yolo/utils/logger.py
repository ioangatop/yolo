...
Instactions:
    ...
    - Use `from loguru import logger` anywhere in your code and use logger.debug(), \
        logger.info(), logger.warning() regardless of the location of the code. Those \
        logs will be nicely formatted and printed to stdout by default, and optionally to file as well.
